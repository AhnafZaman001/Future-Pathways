-- =========================================================
-- Load-test seed, PART 2: students 6-100.
-- Run supabase/load_test_seed_100_students.sql's first 5 students
-- (or verify you already have) BEFORE this file -- these continue
-- numbering from where that leaves off. Do not re-run students 1-5,
-- that will hit a duplicate-email conflict on auth.users.
-- =========================================================
